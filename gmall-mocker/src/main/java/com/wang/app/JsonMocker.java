...
import com.wang.uploader.LogUploader;
import com.wang.utils.RanOpt;
import com.wang.utils.RandomDate;
import com.wang.utils.RandomNum;
import com.wang.utils.RandomOptionGroup;
...
public class JsonMocker {
    ...
    private RanOpt[] eventOpts = {new RanOpt("addFavor", 10), new RanOpt("addComment", 30),new RanOpt("addCart", 20),
            new RanOpt("clickItem", 4), new RanOpt("coupon", 80)};
